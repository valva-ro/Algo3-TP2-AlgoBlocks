...
public class BotonBloqueEspecial extends Boton {
    ...
    public BotonBloqueEspecial(String bloqueID, String texto, Algoritmo algoritmo) {
        super(bloqueID, texto);
        this.setOnDragDetected(new BotonBloqueOnDragDetectedHandler(this));
        this.setOnDragDropped(new BotonBloqueEspecialDragDroppedHandler(bloquesContenidos, new BloquePersonalizado(), algoritmo));
    }
}
