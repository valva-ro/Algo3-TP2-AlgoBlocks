...
public class VistaPrincipal extends BorderPane {
    ...
    public VistaPrincipal(App aplicacion, Stage escenario, SectorDibujo sectorDibujo, SectorBloques sectorBloques, Algoritmo algoritmo) {
        this.setStyle("-fx-background-color: #e0fee0");

        SectorBloquesDisponiblesVista bloquesDisponiblesVista = new SectorBloquesDisponiblesVista(sectorBloques, algoritmo);
        SectorAlgoritmoVista sectorAlgoritmoVista = new SectorAlgoritmoVista(algoritmo, sectorDibujo, sectorBloques, aplicacion, escenario);
